...
\maketitle
\begin{frame}[label={sec:orgaacc70b}]{Technica ShellSlayer Fall 2025 Workshop}
...
\textbf{If you don't have Docker installed, punch ``Install Docker'' into a
browser and install it!}
\end{block}
\end{frame}
\begin{frame}[label={sec:org985f8d4}]{Welcome Slayers}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgbf22237}]{Docker Setup}
\vspace{-.4in}
\begin{columns}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge5c9ef3},fragile]{Running Shell Slayer}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9d4342d},fragile]{Structure of the Exercise}
 \begin{description}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7cfe65e},fragile]{Workshop Plan}
 \vspace{-.4in}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga98906e},fragile]{Thank You for Your Participation}
